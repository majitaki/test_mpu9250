...
class FaBo9Axis {
  public:
    FaBo9Axis(int addr = MPU9250_SLAVE_ADDRESS);
    bool begin(void);
    bool searchDevice(void);
    void configMPU9250(int gfs = MPU9250_GFS_250, int afs = MPU9250_AFS_2G);
    void configAK8963(int mode = AK8963_MODE_C8HZ, int mfs = AK8963_BIT_16);
    bool checkDataReady();
  ...
  private:
    ...
    void writeI2c(int address, int register_addr, int data);
    void readI2c(int address, int register_addr, int num, int * buffer);
};
